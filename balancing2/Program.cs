...
namespace balancing
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //                        if (rightElements > 0)
            //                        {
            //                            right.Add(eq[i].ToString(), p);
            //                            Mas[p][colomns] = -koef * temp;
            //                        }
            //                        else
            //                        {
            //                            elemK.Add(eq[i].ToString(), p);
            //                            Mas[p][colomns] = koef * temp;
            //                        }
            ...
            //                        if (rightElements > 0)
            //                        {
            //                            Mas[Int32.Parse((right.GetByIndex(right.IndexOfValue(eq[i].ToString()))).ToString())][colomns] = -koef * temp;
            //                        }
            //                        else
            //                        {
            //                            Mas[Int32.Parse((elemK.GetByIndex(elemK.IndexOfValue(eq[i].ToString()))).ToString())][colomns] = koef * temp;
            //                        }

            //                    }
            //                    else if (rightElements > 0)
            //                    {
            //                        Mas[Int32.Parse((right.GetByIndex(right.IndexOfValue(eq[i].ToString()))).ToString())][colomns] = -temp;
            //                    }
            //                    else
            //                    {
            //                        Mas[Int32.Parse((elemK.GetByIndex(elemK.IndexOfValue(eq[i].ToString()))).ToString())][colomns] = temp;
            //                    }
            //                }
            ...
            //                        if (rightElements > 0)
            //                        {
            //                            Mas[Int32.Parse((right.GetByIndex(right.IndexOfValue(eq[i].ToString()))).ToString())][colomns] = -koef;
            //                        }
            //                        else
            //                        {
            //                            Mas[Int32.Parse((elemK.GetByIndex(elemK.IndexOfValue(eq[i].ToString()))).ToString())][colomns] = koef;
            //                        }

            //                    }
            //                    else if (rightElements > 0)
            //                    {
            //                        Mas[Int32.Parse((right.GetByIndex(right.IndexOfValue(eq[i].ToString()))).ToString())][colomns] = -1;
            //                    }
            //                    else
            //                    {
            //                        Mas[Int32.Parse((elemK.GetByIndex(elemK.IndexOfValue(eq[i].ToString()))).ToString())][colomns] = 1;
            //                    }
            //                }
